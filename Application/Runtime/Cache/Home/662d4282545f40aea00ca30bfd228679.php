	...
	<div class="main">
		...
		<div class="main_right">
			...
			<div class="common_main">
				<h2>列表展示<a href="/hizhu/AgentsManage/downloadMiddleManExcel.html?<?php echo $_SERVER["QUERY_STRING"];?>" class="btn_a" style="min-width: 100px">下载</a></h2>
				<div class="table">
					<table>
						<thead>
							<tr>
						...
						<tbody>
						  	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									...
									<a href="/hizhu/AgentsManage/refuseReason.html?no=6&leftno=189&origin=2&id=<?php echo ($vo["id"]); ?>">&nbsp;&nbsp;拒绝</a>
