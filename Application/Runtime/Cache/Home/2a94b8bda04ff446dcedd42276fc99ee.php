			 ...
			 <div class="slider">
			    <div class="callbacks_container">
			      ...
			      <?php if(is_array($images)): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
			          	 ...
			          	 <div class="banner1" style="background-image: url(/Public/Uploads/<?php echo ($v["image"]); ?>)  ">
			           		<div class="caption">
					          	<h3>去旅行,去生活</h3>
					          	<p>哪怕就住一晚</p>
			          		</div>
	...
	<div class="top-grid">
		...
		<div class="grid-at">
			<div class="col-md-3 grid-city">
				<div class="grid-lo">
					<a href="<?php echo U('Search/type',array('id'=>$cimage['0']['cid']));?>">
						<figure class="effect-layla">
						<img class=" img-responsive" src="/Public/Uploads/<?php echo ($cimage['0'][image]); ?>" alt="img06">
						<figcaption>
			...
			<div class="col-md-3 grid-city">
				<div class="grid-lo">
						<a href="<?php echo U('Search/type',array('id'=>$cimage['1']['cid']));?>">
					<figure class="effect-layla">
						<img class=" img-responsive" src="/Public/Uploads/<?php echo ($cimage['1'][image]); ?>" alt="img06">
						<figcaption>
			...
			<div class="col-md-6 grid-city grid-city1">
				...
				<div class="col-md-8 grid-lo1">
					<div class=" grid-lo">
							<a href="<?php echo U('Search/type',array('id'=>$cimage['2']['cid']));?>">
					<figure class="effect-layla">
						<img class=" img-responsive" src="/Public/Uploads/<?php echo ($cimage['2'][image]); ?>" alt="img06">
						<figcaption>
				 ...
				 <div class="col-md-4 grid-lo2">
				 	<div class=" grid-lo">
				 			<a href="<?php echo U('Search/type',array('id'=>$cimage['3']['cid']));?>">
					<figure class="effect-layla">
						<img class=" img-responsive" src="/Public/Uploads/<?php echo ($cimage['3'][image]); ?>" alt="img06">
						<figcaption>
			...
			<div class="grid-me">
				<div class="col-md-6 grid-lo3">
					<div class=" grid-lo">
							<a href="<?php echo U('Search/type',array('id'=>$cimage['4']['cid']));?>">
					<figure class="effect-layla">
						<img class="img-responsive" src="/Public/Uploads/<?php echo ($cimage['4'][image]); ?>" alt="img06">
						<figcaption>
				 ...
				 <div class="col-md-6 grid-lo4">
				 	<div class=" grid-lo">
				 			<a href="<?php echo U('Search/type',array('id'=>$cimage['5']['cid']));?>">
					<figure class="effect-layla">
						<img class="img-responsive" src="/Public/Uploads/<?php echo ($cimage['5'][image]); ?>" alt="img06">
						<figcaption>
			...
			<div class="content-bottom-in">
					<ul id="flexiselDemo1">			
						<li><div class="project-fur">
								<a href="<?php echo U('Display/index',array('id'=>1));?>" ><img class="img-responsive" src="/Public/Home/images/pi.jpg" alt="" />	</a>
									<div class="fur">
										<div class="fur1">
							...
							<li><div class="project-fur">
									<a href="<?php echo U('Display/index',array('id'=>2));?>" ><img class="img-responsive" src="/Public/Home/images/pi1.jpg" alt="" />	</a>
										<div class="fur">
											<div class="fur1">
			                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
			                                   <h6 class="fur-name"><a href="single.html">Contrary to popular</a></h6>
								...
								<li><div class="project-fur">
								<a href="<?php echo U('Display/index',array('id'=>3));?>" ><img class="img-responsive" src="/Public/Home/images/pi2.jpg" alt="" />	</a>
									<div class="fur">
										<div class="fur1">
		                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
		                                   <h6 class="fur-name"><a href="/Public/Home/single.html">Contrary to popular</a></h6>
		                                   	<span>Paris</span>
                               			</div>
			                            <div class="fur2">
			                               	<span>2 BHK</span>
							...
							<li><div class="project-fur">
								<a href="<?php echo U('Display/index',array('id'=>4));?>" ><img class="img-responsive" src="/Public/Home/images/pi3.jpg" alt="" />	</a>
									<div class="fur">
										<div class="fur1">
		                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
		                                    <h6 class="fur-name"><a href="single.html">Contrary to popular</a></h6>
