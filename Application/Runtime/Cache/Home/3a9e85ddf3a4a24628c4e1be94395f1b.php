		...
		<div class="main_right">
			<div class="common_head">
				...
				<div class="common_head_main">
					<form id="searchForm" action="/hizhu/HouseResourcerob/resourcelist" method="get">
						<input type="hidden" name="no" value="3">
						<input type="hidden" name="leftno" value="81">
					...
					<table>
						...
						<tbody>
							<?php if(is_array($list)): foreach($list as $key=>$list): ?><tr>
								...
								<td><?php echo ($list["update_man"]); ?></td><td><?php echo ($list["ext_score"]); ?></td>
								<td><a href="javascript:;" onclick="addBlack('<?php echo ($list["client_phone"]); ?>')">拉黑</a></td>
