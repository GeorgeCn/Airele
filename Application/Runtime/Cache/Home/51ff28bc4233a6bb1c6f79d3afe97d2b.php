...
<div class="login-right">
	<div class="container">
		...
		<div class="login-top">
				...
				<div class="form-info">
					<form action="<?php echo U('Yonghu/doadd');?>" method="post">
						<input type="text"   placeholder="Name" required=""  name="nickname">
						<input type="text"   placeholder="telephone" required="" name="tel">
						<input type="password"  placeholder="Password " required="" name="pwd">
						<input type="password"  placeholder="Repassword " required="" name="repwd">
						<input type="hidden"  value="<?php echo time()?>" required="" name="regtime">
