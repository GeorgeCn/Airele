...
<body> <div class="citySelect"><!-- 城市切换 -->
	...
	<div class="main">
		...
		<div class="main_right">
			<div class="common_head">
				...
				<form action="<?php echo U('Finance/financeList');?>" method="get">
					<table class="table_one">
						<tr>
							...
							<td class="td_main"><input type="text" name="ownername" class="inpt_a" value="<?php echo$_GET['ownername']?>">
							</td>
						...
						<tr>
							...
							<td class="td_main">
								<select name="pay_platform" style="width:100px;";>
							...
							<td class="td_main"><input type="tel" name="orderid" value="<?php echo$_GET['orderid']?>"></td>
					...
					<table>
						...
						<tbody>
						  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="money"><span><?php echo ($vo['order_pirce_cnt']); ?></span></td>
								<td><?php if(strtoupper($vo['order_status']) == '4'): ?>已付款<?php endif; ?></td>
								<td>
									<?php if(strtoupper($vo['pay_platform']) == '0'): ?>微信
									<?php elseif(strtoupper($vo['pay_platform']) == '1'): ?>
									 银联
									<?php elseif(strtoupper($vo['pay_platform']) == '2'): ?>
									支付宝<?php endif; ?>
								</td>
								<td><?php echo (date("Y-m-d H:i:s",$vo['create_time1'])); ?></td>
								<td class="<?php echo ($vo['id']); ?>"></td>
								<td><a href="<?php echo U('Finance/financeDetailed');?>?oid=<?php echo ($vo['id']); ?>">操作</a></td>
							</tr>
