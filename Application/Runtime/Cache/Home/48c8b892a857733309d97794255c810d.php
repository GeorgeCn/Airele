                    ...
                    <div class="view5 is-loaded">
                        <div class="card profile-manager">
                            <div class="card-content">
                                <form action="<?php echo U('Personal/doedit');?>" method="post">
                                    原密码：
                                    ...
                                    确认密码：
                                        ...
                                        <input type="text" name="code"><a id="code" style="cursor:pointer">获取短信验证码</a><br><br>
                                    <button class="btn-warning">确认修改</button>
                                </form>
                            </div>
                        </div>
                    </div><!-- END view5-->
    ...
    <script>
        $("#code").click(function(){
            // alert("aaaa");
                $.ajax({
                    type:'get',
                    url:"<?php echo U('Personal/seepwd');?>",
                    dataType:'json',
