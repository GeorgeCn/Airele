	...
	<div class="main">
		...
		<div class="main_right">
			<div class="common_head">
				...
				<form action="<?php echo U('Stores/storeMyHouses');?>" method="get">
						<input type="hidden" name="no" value="162">
						<input type="hidden" name="leftno" value="175">
					...
					<table>
						...
						<tbody>
						  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="<?php echo U('stores/storeMyHouseDetail?no=162&leftno=164',array('id'=>$vo['id']));?>" id="storeTitle"><?php echo ($vo['title']); ?></a></td>
