	...
	<div class="main">
		...
		<div class="main_right">
			<div class="common_head">
				...
				<form action="/hizhu/AgentsManage/middlemansCoreManageList.html" method="get">
				   <input type="hidden" name="no" value="6">
				    <input type="hidden" name="leftno" value="207">
...
<script>
	...
	$(document).ready(function(e) {
		$("#transfer tr").each(function(){
			...
			window.open("/hizhu/AgentsManage/middlemansCoreInfo.html?no=6&leftno=207&id="+customer_id,'_blank');
			})
		});
	})
	$(document).ready(function(e) {
