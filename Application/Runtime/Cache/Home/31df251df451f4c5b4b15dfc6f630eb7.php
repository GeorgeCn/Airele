                    ...
                    <div class="view5 is-loaded">
                        <div class="card profile-manager">
                            <div class="card-content">
                                    <h1>编辑个人资料</h1><br><br>
                                <form action="<?php echo U('Personal/dosave');?>" method="post">
                                    用户名：
                                        <input type="text" name="nickname" value="<?php echo ($vo['nickname']); ?>"><br><br>
                                    性别：
                                        <input type="radio" name="sex" value="1" <?php if($vo["sex"] == 1): ?>checked<?php endif; ?>>男
                                        <input type="radio" name="sex" value="0" <?php if($vo["sex"] == 0): ?>checked<?php endif; ?>>女
                                        <input type="radio" name="sex" value="2" <?php if($vo["sex"] == 2): ?>checked<?php endif; ?>>保密<br><br>
                                    邮箱：
                                        <input type="email" name="email" value="<?php echo ($vo['email']); ?>"><br><br>
                                    破壳日：
                                        <input type="date" name="birthday" value="<?php echo ($vo['birthday']); ?>"><br><br>
                                    <!-- 密码：
                                        <input type="text" name="pwd"><br><br>
                                    确认密码：
                                        <input type="text" name="repwd"><br><br> -->
