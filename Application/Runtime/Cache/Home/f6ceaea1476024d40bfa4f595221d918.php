...
<script type="text/javascript">
		...
		<div class="main_right">
			...
			<h2></h2>
				...
				<div class="common_main">
					<h2>房间Banner列表<a href="/hizhu/AdConfiguration/addroomtemp.html?no=1&leftno=157" class="btn_a">新增banner</a></h2>
				<div class="table">
					<table>
						<thead>
							<tr>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<a href="/hizhu/AdConfiguration/updateroomtemp.html?no=1&leftno=157&upid=<?php echo ($vo['id']); ?>">修改</a></td>
   ...
   <script>
   	function deletedata(pid){
		$.post('/hizhu/AdConfiguration/removeroomadindex.html',{pid:pid},function(data){
			if(data.status!="200"){
				alert(data.msg);
