...
<link href="/Public/css/PersonOrders.css" rel="stylesheet" />

<div class="site-main">
<div class="container">
<div class="row">
	<div class="wechat-label"><h2 style="text-align:center;line-height:80px;">个人中心</h2></div>
<div class="col-sm-1 col-md-2 main-sidebar">
<div class="view3">
...
<div class="card-header"><h3 class="card-title">我的订单</h3></div>
			...
			<div class="order-list-body">
				<ul class="j_allorderli">
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<table class="table table-striped order-list j_product" id="indent{$vo['id']}" >
								<tr>
								...
								<tbody>
									...
									<tr>
										<td width="520" class="all-goods">
											<a href="<?php echo U('Details/index',array('id'=>$vo['gid']));?>" target="_blank"><img class="j_product_img" src="/Public/uploads/<?php echo ($vo["filename1"]); ?>"></a>
											<div class="m"><div><?php echo ($vo["address"]); ?></div></div>
										</td>
										...
										<td width="140">
											<?php if($vo["ispay"] == 2): ?>已支付<?php else: ?><a class="btn-success" href="<?php echo U('PersonOrders/pay',array('id'=>$vo['id']));?>">去支付</a><?php endif; ?>
										</td>
										<td width="140" class="operate">
											<div>
												<?php if($vo["status"] == 2): ?><a class="btn-success btn-org" href="<?php echo U('PersonOrders/stay',array('id'=>$vo['id']));?>">入住</a>
												<?php elseif($vo["status"] == 3): ?><a class="btn-danger btn-org" href="<?php echo U('PersonOrders/out',array('id'=>$vo['id']));?>">退房</a>
												<?php else: ?>	
												<a class="btn-danger" target="_blank" href="<?php echo U('Like/doadd',array('gid'=>$vo['gid']));?>">去点赞</a><?php endif; ?>
												
											</div>
											<div <?php if($vo["ispay"] == 1): ?>style="display:none"<?php endif; ?>>
												
												<a class="btn-info btn-org" href="<?php echo U('PersonOrders/comment',array('id'=>$vo['id']));;?>">去评价</a>
												
											</div>
											<div>
												<?php if($vo["ispay"] == 2): ?><a class="btn-org" href="<?php echo U('PersonOrders/complain',array('oid'=>$vo['id']));?>">去投诉</a><?php else: ?>
