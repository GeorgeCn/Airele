...
<div class="card-header"><h3 class="card-title">我的收藏</h3></div>
<div class="card-content">
	<br>

	<table width=90% cellpadding="5" cellspacing="3" class="table table-striped">
			...
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td>
						<a class="btn-info" href="<?php echo U('Display/index',array('id'=>$vo['gid']));?>">查看详情</a>
						
						<a class="btn-warning" href="<?php echo U('Collect/del',array('id'=>$vo['id']));?>">删除</a>
					</td>
