	...
	<div class="main">
		...
		<div class="main_right">
			<div class="common_head">
				...
				<form action="/hizhu/AgentsManage/middlemansManageList.html" method="get" id="searchForm">
				    <input type="hidden" name="no" value="6">
				    <input type="hidden" name="leftno" value="206">
			...
			<div class="common_main">
				<h2>中介列表
				<a style="margin-left:20px;" class="btn_a" href="/hizhu/AgentsManage/middlemansAdd.html?no=6&leftno=206">新增</a>
				<a style="margin-left:150px;" href="/hizhu/AgentsManage/downloadExcel?<?php echo $_SERVER["QUERY_STRING"];?>" class="btn_a">数据下载</a>
				</h2>
				<div class="table">
					<table>
						<thead>
...
$(document).ready(function(e) {
	...
	trList.click(function() {
		...
		window.open("/hizhu/AgentsManage/middlemansManageDetail.html?no=6&leftno=206&id="+customer_id,'_blank');
	})
})
//中介公司
