	...
	<div class="main">
		...
		<div class="main_right">
			<div class="common_head">
				...
				<form action="<?php echo U('Stores/storesList');?>" method="get">
					...
					<table class="table_one">
						<tr>
							...
							<td class="td_main">
								<select name="type">
							        <option value="" <?php if($_GET['type']===""){echo "selected";}?>>全部</option>
							    	<option value="1" <?php if($_GET['type']=="1"){echo "selected";}?>>金牌店铺</option>
							    	<option value="2" <?php if($_GET['type']=="2"){echo "selected";}?>>银牌店铺</option>
							    	<option value="0" <?php if($_GET['type']=="0"){echo "selected";}?>>普通店铺</option>
							    </select>
							</td>
						</tr>
						<tr>
							<td class="td_title">信用分：</td>
							<td class="td_main"><input class="inpt_a" type="text" name="downScore" value="<?php echo I('get.credit_score');?>">&nbsp;~&nbsp;<input class="inpt_a" type="text" name="upScore" value="<?php echo I('get.credit_score');?>"></td>
							<td class="td_title">店铺ID：</td>
							<td class="td_main"><input type="text" name="storeId" value="<?php echo I('get.storeId');?>"></td>
			...
			<div class="common_main">
				<h2>店铺列表<a href="<?php echo U('Stores/storeCreate?no=162');?>" class="btn_a" style="min-width: 100px">新增店铺</a>
				</h2>
				<div class="table">
					<table>
						<thead>
						...
						<tbody>
						  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><a href="<?php echo U('stores/storeDetail?no=162&leftno=164',array('id'=>$vo['id']));?>" id="storeTitle"><?php echo ($vo['title']); ?></a></td>
