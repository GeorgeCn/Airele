	...
	<div class="main">
		...
		<div class="main_right">
			...
			<div class="common_main">
				<!-- 表单 -->
				<form method="post" action="/hizhu/AdConfiguration/submitroomadindex.html" id="submitForm" enctype='multipart/form-data'>
				   <input name="type" type="hidden" value="update">
				    ...
				    <table class="table_one table_two"> 	
						<tr>
							...
							<td class="td_main">
								<input type="text" name="room_no" value="<?php echo ($adindex['room_no']); ?>">
							</td>
						</tr>
