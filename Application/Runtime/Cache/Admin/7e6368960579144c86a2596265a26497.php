...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo U('City/csave');?>" method='post' class="form-horizontal" enctype="multipart/form-data">

				<div class="form-group">
					<label class="h4 col-lg-3 control-label no-padding-right" for="form-field-5">城市</label>

					<div class="col-sm-9">
						<select id="pro" name="cid">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($data['cid'] == $v['id']): ?><option value="<?php echo ($v["id"]); ?>" selected><?php echo ($v["name"]); ?></option><?php endif; ?>
							<?php if($data['cid'] != $v['id']): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
						</select>
				...
				<div class="form-group">
					<label class="h4 col-lg-3 control-label no-padding-right">图片<span class="required">*</span></label>
					<div class="col-sm-9">
						<img src="/Public/uploads/<?php echo ($data["image"]); ?>" alt="" style='width:150px;height:150px;border:2px solid #ccc'>
