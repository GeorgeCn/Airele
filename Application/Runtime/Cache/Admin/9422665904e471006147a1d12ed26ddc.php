...
<html lang="en">
    ...
    <div class=".table-responsive">
        <table id="table_comment" class="table table-bordered table-hover" style="table-layout:fixed">
            <tr class="active">
                <th style='vertical-align: middle;text-align: center;' width="5%">序号</th>
                <th style='vertical-align: middle;text-align: center;' width="15%">房屋名</th>
                <th style='vertical-align: middle;text-align: center;' width="10%">用户名</th>
                <th style='vertical-align: middle;text-align: center;' width="*">评论内容</th>
                <th style='vertical-align: middle;text-align: center;' width="10%">评论时间</th>
                <th style='vertical-align: middle;text-align: center;' width="25%">操作</th>
            </tr>
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="success">
                <td style='vertical-align: middle;text-align: center;'><?php echo ($vo['id']); ?></td>
                <td style='vertical-align: middle;text-align: center;'><?php echo ($vo['name']); ?></td>
                <td style='vertical-align: middle;text-align: center;'><?php echo ($vo['nickname']); ?></td>
                <td style='vertical-align: middle;text-align: center;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;' class="look_more"><?php echo ($vo['desc']); ?></td>
                <td style='vertical-align: middle;text-align: center;'><?php echo ($vo['createtime']); ?></td>
                <td style='vertical-align: middle;text-align: center;'>
                    <a href="<?php echo U('delete', array('id'=>$vo['id']));?>" class="btn btn-warning">删除</a>
                    <button id="btn_comment" class="btn-info">点击查看详情</button> 
                </td>
    ...
    <?php echo ($page); ?>                          
    <script>
        $(".success .btn-info").click(function(){
            var a =$(this).parent().parent().find(".look_more");
            var b = a.css("white-space");
            if(b=="nowrap"){
                a.css("white-space","normal");
                a.css("overflow","block");
                a.css("text-overflow","clip");
                $(this).html("再次点击收起");
            }else{
