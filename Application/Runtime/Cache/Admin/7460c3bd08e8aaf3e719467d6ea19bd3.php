...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/Public/Css/goodsindex.css">	
	...
	<body>
		...
		<h5 class="bigger lighter red text-center">
			<i class="icon-table"></i>
		表格 & 信息
		</h5>
		<div id="search" style="margin:20px auto">
			<form action="<?php echo U('Goods/search');?>" method='get' class="h5" style="font-weight:30px">
			Category Name : <input type="text" name="id" class='search' placeholder="请输入: 房屋编号/分类编号">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td class="hidden-480 text-center"><?php echo ($vo["id"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["cid"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["name"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["up"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["hot"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["time"]); ?></td>
						<td class="hidden-480 text-center">
							<?php if($vo["status"] == 0): ?><span class="label label-inverse text-center"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">去冻结</a></span>
							<?php elseif($vo["status"] == 1): ?>
								<span class="label label-warning"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">来激活</a></span><?php endif; ?>
						</td>
						<td class="hidden-480 text-center">
						<a href="<?php echo U('more',array('id'=>$vo['id']));?>" class="btn btn-common">详情图片</a>
						<a href="<?php echo U('edit',array('id'=>$vo['id']));?>" class="btn btn-primary">编辑</a>
