		...
		<table class="table">
			...
			<?php else: ?>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<?php if($vo["status"] == 1): ?><a class="btn btn-success" href="<?php echo U('Orders/confirm',array('id'=>$vo['id']));?>">确定
								</a>
							<?php else: ?>
								已确定<?php endif; ?>
						</td>
						...
						<!-- <td>
							<?php if($vo["status"] == 4): ?>已退房
							<?php else: ?>
							<a href="<?php echo U('Orders/details',array('id'=>$vo['id']));?>">退房</a><?php endif; ?>
