...
<html lang="en">
        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div id="collapseOne" class="accordion-body collapse in body">
                    <form action="<?php echo U('Header/doupload');?>" class="form-horizontal" id="block-validate" novalidate="novalidate" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-actions no-margin-bottom" style="text-align:center;">
                            <input type="submit" value="上传" class="btn btn-primary btn-lg ">
                        </div>
	...
	<!-- <form action="<?php echo U('Public/doupload');?>" method="post" class='col-md-4' enctype="multipart/form-data">
		
		<div class="form-group">
		<label for="#" class="">添加图片：</label>
