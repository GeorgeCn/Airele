...
<html lang="en">
    ...
    <div id="search" style="margin:20px auto">
            <form action="#" method='get' class="h5" style="font-weight:30px">
            Advertise Name : <input type="text" name="id" class='search' placeholder="请输入: 广告编号">
    ...
    <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td class="hidden-480 text-center"><?php echo ($vo["company"]); ?></td>
                        <td class="hidden-480 text-center"><?php echo ($vo["url"]); ?></td>
                        <td>
                        <img src="/Public/Uploads/<?php echo ($vo["filename1"]); ?>">
                        </td>
                        <td class="hidden-480 text-center"><?php echo ($vo["desc"]); ?></td>
                        <td class="hidden-480 text-center"><?php echo ($vo["createtime"]); ?></td>
                        <td class="hidden-480 text-center">
                            <?php if($vo["status"] == 1): ?><span class="label label-inverse text-center"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">禁用</a></span>
                            <?php elseif($vo["status"] == 0): ?>
                                <span class="label label-warning"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">启用</a></span><?php endif; ?>
                        </td>
                        <td class="hidden-480 text-center">
