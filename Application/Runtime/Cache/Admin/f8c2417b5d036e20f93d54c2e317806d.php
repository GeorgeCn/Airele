	...
	<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
					<!-- <td><?php echo ($vo["id"]); ?>在吗</td> -->
					<td><?php echo ($v["id"]); ?></td>
					<td><?php echo ($v["city"]); ?></td>
					<td>
						<span id="example4" href="assets/img/demoBig2.jpg" title="Cras neque mi, semper leon"><img src="/Public/Uploads/<?php echo ($v["image"]); ?>" alt="" style='width:300px;height:200px'></span>
					</td>
					<!-- <td><?php if($v["status"] == 0): ?><a href="<?php echo U('Header/ssave',array('id'=>$v['id'],'status'=>$v['status']));?>">下架</a>
						<?php else: ?> <a href="<?php echo U('Header/ssave',array('id'=>$v['id'],'status'=>$v['status']));?>">上架</a><?php endif; ?>
					</td> -->
					<td>
						<!-- <a href="<?php echo U('Header/delete',array('id'=>$v['id']));?>">删除</a> -->
						<a href="<?php echo U('City/edit',array('id'=>$v['id']));?>">修改</a>
					</td>
