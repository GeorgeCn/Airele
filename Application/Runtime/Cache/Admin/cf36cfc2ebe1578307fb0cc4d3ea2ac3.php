...
<html lang="en">
	<head>
		...
		<script src="/RealHome/Public/js/jquery.min.js"></script>
	...
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo U('Role/save');?>" method='post' class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input  type="text" name="remark" class="form-control" value="<?php echo ($vo["remark"]); ?>">
					</div>
				</div>
