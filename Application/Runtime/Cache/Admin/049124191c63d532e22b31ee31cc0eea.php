...
<html lang="en">
	...
	<h1>
		...
		<table class="table">
			...
			<?php if($a == a): ?><tr><td colspan="9" style="text-align:center;">所有订单已处理完毕<a href="<?php echo U('Orders/index');?>">返回订单首页</a></td>
				</tr>
			<?php else: ?>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<?php if($vo["status"] >= 2): ?>已确定
							<?php else: ?>
								<a class="btn btn-success" href="<?php echo U('Orders/confirm',array('id'=>$vo['id']));?>">确定
								</a><?php endif; ?>
						</td>
						<td><?php if($vo["ispay"] == 1): ?>未支付<?php else: ?>已支付<?php endif; ?>
						</td>
						<td>
							<a class="btn btn-success" href="<?php echo U('Orders/cancle',array('id'=>$vo['id']));?>">取消
								</a>

							<a class="btn btn-success" href="<?php echo U('Orders/dostay',array('id'=>$vo['id']));?>">入住
								</a>
						</td>
