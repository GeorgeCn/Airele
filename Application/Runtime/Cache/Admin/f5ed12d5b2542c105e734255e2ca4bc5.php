...
<html lang="en">
    ...
    <div class="row">
        <div class="col-md-12">
            <form action="<?php echo U('Blogroll/doadd');?>" method='post' class="form-horizontal">

                <div class="form-group" style="">
                    <label for="" class="col-sm-2 control-label">网站名称：</label>
                    <div class="col-sm-4">
                        <input type="text" name="name" class="form-control" value="<?php echo ($vo["name"]); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">URL地址：</label>
                    <div class="col-sm-4">
                        <input  type="text" name="italic" class="form-control" value="<?php echo ($vo["italic"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input  type="text" name="desc" class="form-control" value="<?php echo ($vo["desc"]); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input  type="text" name="contacts" class="form-control" value="<?php echo ($vo["contacts"]); ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">站长email：</label>
                    <div class="col-sm-4">
