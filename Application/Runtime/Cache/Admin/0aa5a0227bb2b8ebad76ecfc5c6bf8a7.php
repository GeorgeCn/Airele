...
<html lang="en">
    ...
    <table class="table table-bordered table-hover">
        <tr class="active">
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>序号</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>昵称</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>手机号</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>性别</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>邮箱</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>状态</th>
            <th rowspan=$rowspan style='vertical-align: middle;text-align: center;'>操作</th>
        </tr>
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'><?php echo ($vo['id']); ?></td>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'><?php echo ($vo['nickname']); ?></td>
            <td  rowspan=$rowspan style='vertical-align: middle;text-align: center;'><?php echo ($vo['tel']); ?></td>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'>
                <?php if($vo['sex'] == '0'): ?>女
                <?php elseif($vo['sex'] == '1'): ?>男
                <?php else: ?>保密<?php endif; ?>
            </td>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'><?php echo ($vo['email']); ?></td>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'>
                <a href="<?php echo U('Yonghu/dostatus',array('status'=>$vo['status'],'id'=>$vo['id']));?>">
                    <button class="btn-info">
                        <?php if($vo['status'] == '0'): ?>冻结
                        <?php else: ?>正常<?php endif; ?>
                    </button>
                </a>
            </td>
            <td rowspan=$rowspan style='vertical-align: middle;text-align: center;'>
                <a href="<?php echo U('Yonghu/reset',array('id'=>$vo['id']));?>"><button class="btn-warning">重置密码</button></a>
            </td>
