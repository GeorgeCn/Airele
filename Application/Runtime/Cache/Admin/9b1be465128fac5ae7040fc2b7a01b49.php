...
<div class="page-content">
	<div class="row">
		...
		<!-- PAGE CONTENT BEGINS -->
			...
			<div id="dropzone" >
				<form action="<?php echo U('GoodsImg/insert');?>" method="post"  style="padding:40px" enctype='multipart/form-data'>
				
						<div class="col-sm-12" style="margin-bottom:20px;padding:20px">
							<span class="col-xs-12 col-sm-3">
								<span class="middle red">airbnb去旅行,去生活&nbsp;房屋ID</span>
							</span>
							<input type="text" name="gid" id="form-field-2"  class="col-xs-7 col-sm-2" value="<?= empty($gid)?'请填写房屋ID':$gid?>"/>
						</div>
			...
			<!-- 	<form action="<?php echo U('GoodsImg/insert');?>" method='post' enctype='multipart/form-data'>
