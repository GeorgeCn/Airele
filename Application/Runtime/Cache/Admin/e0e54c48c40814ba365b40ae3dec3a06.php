...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo U('Node/save');?>" method='post' class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input  type="text" name="mname" class="form-control" value="<?php echo ($vo["mname"]); ?>">
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-sm-2 control-label">操作：</label>
					<div class="col-sm-4">
						<input  type="text" name="aname" class="form-control" value="<?php echo ($vo["aname"]); ?>">
					</div>
				</div>
