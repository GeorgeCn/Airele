...
<html lang="en">
    ...
    <link rel="stylesheet" href="/Public/Js/kind/themes/default/default.css">
    <script src="/Public/Js/kind/kindeditor-min.js"></script>
    <script src="/Public/Js/kind/lang/zh_CN.js"></script>
    <script>
            var editor;
				...
				<div class="sidebar" id="sidebar">
					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu" <?php if((CONTROLLER_NAME) == "Orders"): ?>style="display:block"<?php endif; ?>>
								...
								<li <?php if((CONTROLLER_NAME== 'Orders') and (ACTION_NAME== 'deal')): ?>class="active"<?php endif; ?>>
									<a href="<?php echo U('Orders/deal');?>"  >
										<i class="icon-double-angle-right icon-plus"></i>
										确认订单
									</a>
								</li>
								<li <?php if((CONTROLLER_NAME== 'Orders') and (ACTION_NAME== 'stay')): ?>class="active"<?php endif; ?>>
									<a href="<?php echo U('Orders/stay');?>"  >
										<i class="icon-double-angle-right icon-plus"></i>
										入住状态
									</a>
								</li>
								<li <?php if((CONTROLLER_NAME== 'Orders') and (ACTION_NAME== 'out')): ?>class="active"<?php endif; ?>>
									<a href="<?php echo U('Orders/out');?>"  >
										<i class="icon-double-angle-right icon-plus"></i>
										退房
									</a>
								</li>
					...
					<li>
						...
						<li>
							...
							<ul class="submenu" <?php if((CONTROLLER_NAME) == "Advertise"): ?>style="display:block"<?php endif; ?>>
								<li <?php if((CONTROLLER_NAME== 'Advertise') and (ACTION_NAME== 'index')): ?>class="active"<?php endif; ?>>
									<a href="<?php echo U('Advertise/index');?>">
										<i class="icon-double-angle-right"></i>
										广告列表
									</a>
								</li>
								<li <?php if((CONTROLLER_NAME== 'Advertise') and (ACTION_NAME== 'add')): ?>class="active"<?php endif; ?>>
									<a href="<?php echo U('Advertise/add');?>"  >
										<i class="icon-double-angle-right icon-plus"></i>
										广告添加
									</a>
								</li>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <form action="<?php echo U('Advertise/insert');?>" method="post" class="form-horizontal" role="form" enctype='multipart/form-data'>
                <div class="form-group">
                    <label class="h4 col-sm-3 control-label no-padding-right" for="form-field-1">合作机构</label>

                    <div class="col-sm-9">
                        <input type="text" name="company" id="form-field-1" placeholder="机构名称" class="col-xs-10 col-sm-5" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="h4 col-sm-3 control-label no-padding-right" for="form-field-2"> URL地址 </label>

                    <div class="col-sm-9">
                        <input type="text" name="url" id="form-field-2" placeholder="(https?/ftp/news)" class="col-xs-10 col-sm-5" />
                ...
                <div class="form-group">
                    <label class="h4 col-md-3 control-label no-padding-right" for="form-field-4">负责人</label>

                    <div class="col-sm-9">
                        <input class="input-sm" type="text" name="person" id="form-field-4" placeholder="姓名" />
                ...
                <div class="form-group">
                    <label class="h4 col-lg-3 control-label no-padding-right" for="form-field-5">是否启用 </label>

                    <div class="col-sm-9">
                        <div class="clearfix">
                            <input class="ace" type="checkbox" name="status" value="1" id="id-disable-check" />
                ...
                <div class="form-group">
                    <div class="col-sm-9">
                        <div class="clearfix" style="margin-left:160px">
                            <input type="file" name="img" id="user_pic_input" />
                        </div>
                ...
                <div style="margin-left:80px " class='h4' >&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;描述: <textarea name="desc" ></textarea></div>
