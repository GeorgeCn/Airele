...
<html lang="en">
	...
	<div class="row">
		<div class="col-md-12">
			<form action="<?php echo U('Notice/save');?>" method='post' class="form-horizontal">

				<div class="form-group" style="">
					<label for="" class="col-sm-2 control-label">原公告内容：</label>
					<div class="col-sm-4">
						<?php echo ($vo["content"]); ?>
				...
				<div class="form-group" style="">
					<label for="" class="col-sm-2 control-label">新的公告内容：</label>
					<div class="col-sm-4">
						<textarea id="noticeText" class="form-control" name="content" value="<?php echo ($vo["content"]); ?>" rows="4" placeholder="请输入新的公告内容"></textarea>
