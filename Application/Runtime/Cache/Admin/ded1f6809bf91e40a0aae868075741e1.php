...
<html lang="en">
	...
	<script src='/Public/assets/js/jquery-2.0.3.min.js'>
	</script>
	<script src="/Public/Js/jquery.min.js"></script>
			...
			<div class="row-fluid">
				<ul class="ace-thumbnails">
					<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
							<a href="/Public/assets/images/gallery/image-1.jpg" title="Photo Title" data-rel="colorbox">
								<img alt="192x150" src="/Public/Uploads/<?php echo ($vo["filename2"]); ?>" />
								<div class="tags">
									
									<span class="label-holder">
										<span class="label label-danger">favourite</span>
									</span>
									
									<span class="label-holder">
										<span class="label label-info">collect</span>
									</span>
									<span class="label-holder">
									...
									<span class="label-holder">
										<span class="label label-warning arrowed-in">shit</span>
									</span>
								</div>
							</a>
							<div class="tools">
								...
								<a href="<?php echo U('GoodsImg/face',array('id'=>$vo['id'],'gid'=>$vo['gid']));?>">
									<i class="icon-pencil"></i>
								</a>
								
								<a href="<?php echo U('GoodsImg/del',array('id'=>$vo['id']));?>">
									<i class="icon-remove red"></i>
								</a>
							</div>
