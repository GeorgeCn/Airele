		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="hidden-480 text-center"><?php echo ($vo["persons"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["beds"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["toilets"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["desc"]); ?></td>
						<td class="hidden-480 text-center">
							<a href="<?php echo U('GoodsImg/index',array('gid'=>$vo['id']));?>" class="btn btn-common">查看图片</a>
						</td>
						<td class="hidden-480 text-center">
							<a href="<?php echo U('GoodsImg/add',array('gid'=>$vo['id']));?>" class="btn btn-common">添加图片</a>
						</td>
						<td class="hidden-480 text-center">
							<?php if($vo["up"] == 0): ?><span class="label label-inverse text-center"><a href="<?php echo U('up',array('id'=>$vo['id'],'up'=>$vo['up']));?>">上架</a></span>
							<?php elseif($vo["up"] == 1): ?>
								<span class="label label-warning"><a href="<?php echo U('up',array('id'=>$vo['id'],'up'=>$vo['up']));?>">下架</a></span><?php endif; ?>
						</td>
