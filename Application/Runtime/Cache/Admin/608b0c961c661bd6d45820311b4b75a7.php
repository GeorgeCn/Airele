...
<html lang="en">
	...
	<link rel="stylesheet" href="/RealHome2/Public/Js/kind/themes/default/default.css">
	<script src="/RealHome2/Public/Js/kind/kindeditor-min.js"></script>
	<script src="/RealHome2/Public/Js/kind/lang/zh_CN.js"></script>
	<script>
			var editor;
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form action="<?php echo U('Goods/updata');?>" method="post" class="form-horizontal" role="form">
				<input type="hidden" name="id" value="<?php echo ($id); ?>">
				<div class="form-group">
					<label class="h4 col-sm-3 control-label no-padding-right" for="form-field-1"> 房屋标题</label>

					<div class="col-sm-9">
						<input type="text" name="name" id="form-field-1" placeholder="房屋标题" class="col-xs-10 col-sm-5" value="<?php echo ($data['name']); ?>" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="type" id="form-field-2" placeholder="(公寓/独立房间/合住房间)" class="col-xs-10 col-sm-5" value="<?php echo ($data['type']); ?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select id="pro" name="province" value="<?php echo ($data['province']); ?>"></select>
					    <select id="city" name="city" value="<?php echo ($data['city']); ?>"></select>
					    <select id="area" name="town" value="<?php echo ($data['town']); ?>"></select>
					</div>
				</div>
			  ...
			  <script>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input  type="text" name="address" class="col-xs-10 col-sm-5" id="form-input-readonly"  placeholder="房屋地址" value="<?php echo ($data['address']); ?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input class="input-sm" type="text" name="price" id="form-field-4" placeholder="价格/月" value="<?php echo ($data['price']); ?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="clearfix">
							<input class="ace" type="checkbox" name="hot" value="1" id="id-disable-check" <?php echo ($data['hot'] == 1?'checked':''); ?> />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<span class="input-icon">
							<input type="text" name="months"id="form-field-icon-1" placeholder="数量/月" value="<?php echo ($data['months']); ?>" />
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="beds" id="form-field-tags"  placeholder="数量/张" value="<?php echo ($data['beds']); ?>"/>
						<label class="middle">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="toilets" id="form-field-tags"  placeholder="数量/间" value="<?php echo ($data['toilets']); ?>" />
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="persons" id="form-field-tags"  placeholder="数量" value="<?php echo ($data['persons']); ?>" />
					</div>
				</div>
