...
<html lang="en">
	...
	<!-- <?php echo dump($data);?> -->
		...
		<div id="search" style="margin:20px auto">
			...
			Category Name : <input type="text" name="id" class='search' placeholder="请输入: 订单号">
		...
		<table class="table table-striped table-bordered table-hover">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td class="hidden-480 text-center"><?php echo ($vo["oid"]); ?></td>
						<td class="hidden-480 text-center"><?php echo ($vo["createtime"]); ?></td>
						<td class="hidden-480 text-center">
							<?php if($vo["status"] == 0): ?><span class="label label-inverse text-center"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">处理订单</a></span>
							<?php elseif($vo["status"] == 1): ?>
								<span class="label label-warning"><a href="<?php echo U('status',array('id'=>$vo['id'],'status'=>$vo['status']));?>">来激活</a></span><?php endif; ?>
						</td>
						<td class="hidden-480 text-center">
						<a href="<?php echo U('more',array('id'=>$vo['oid']));?>" class="btn btn-common">订单详情</a>
						</td>
